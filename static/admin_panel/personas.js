...
export async function initializePersonaSection() {
    ...
    function handleEditSelectedClick() {
        ...
        if (selectedPersonaId) {
            fetch(`/chatmanip/admin/personas/${selectedPersonaId}?token=${getToken()}`)
                .then(response => response.json())
                .then(persona => {
    ...
    function handleSavePersonaClick() {
        ...
        const url = selectedPersonaId ? `/chatmanip/admin/personas/${selectedPersonaId}?token=${getToken()}` : `/chatmanip/admin/personas?token=${getToken()}`;
    ...
    function exportPersonaDatabase() {
        console.log(`/chatmanip/admin/personas/export?token=${getToken()}`)
        fetch(`/chatmanip/admin/personas/export?token=${getToken()}`)
            .then(response => response.json())
            .then(data => {
    ...
    function importPersonaDatabase(file) {
        ...
        fetch(`/chatmanip/admin/personas/import?token=${getToken()}`, {
            method: 'POST',
            body: formData,
        })
            .then(response => response.json())
